...
public class GestureDetectMethod_Music {
    ...
    public GestureDetectMethod_Music(ArrayList<EmgData> gesture) {
        compareGesture = gesture;
        numberSmoother = new NumberSmoother();
    }
    public GestureDetectMethod_Music(Handler handler, ArrayList<EmgData> gesture){
        compareGesture = gesture;
        this.handler=handler;
        numberSmoother = new NumberSmoother();
    }

    public GestureDetectMethod_Music(Handler handler, ArrayList<EmgData> gesture, TextView textView, SystemFeature systemFeature) {
        compareGesture = gesture;
    ...
    private blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState getEnum(int i_gesture) {
        switch (i_gesture) {
            case 0:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.Gesture_1;
            case 1:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.Gesture_2;
            case 2:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.Gesture_3;
            case 3:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.Gesture_4;
            case 4:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.Gesture_5;
            case 5:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.Gesture_6;
            default:
                return blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState.No_Gesture;
        }
    ...
    public blueberrycheese.myolifehacker.myo_music.Gesture.GestureDetectMethod_Music.GestureState getDetectGesture(byte[] data) {
...
//                +streamingMaxData.getElement(7)+",");
        ...
        if(cnt%10==0){
            Log.d("hihi", "hihihi");
            cnt=0;
            int result = numberSmoother.getSmoothingNumber_music();
            if(old_gesture_num!=result)
                old_gesture_num = result;

        }
        */
        return getEnum(numberSmoother.getSmoothingNumber_music());
