...
import kotlinx.android.synthetic.main.music_dialog_change_sorting.view.*

class ChangeSortingDialog(val activity: Activity, val callback: () -> Unit) {
    private var currSorting = 0
    var config = activity.config
    var view: View = activity.layoutInflater.inflate(R.layout.music_dialog_change_sorting, null)
