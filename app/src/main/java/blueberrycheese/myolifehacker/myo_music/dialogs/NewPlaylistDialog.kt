...
import blueberrycheese.myolifehacker.R.id.new_playlist_title
...
import kotlinx.android.synthetic.main.music_dialog_new_playlist.view.*
import kotlinx.android.synthetic.main.music_dialog_new_playlist.view.*
...
class NewPlaylistDialog(val activity: Activity, var playlist: Playlist? = null, val callback: (playlistId: Int) -> Unit) {
    ...
    init {
        ...
        val view = activity.layoutInflater.inflate(R.layout.music_dialog_new_playlist, null).apply {
