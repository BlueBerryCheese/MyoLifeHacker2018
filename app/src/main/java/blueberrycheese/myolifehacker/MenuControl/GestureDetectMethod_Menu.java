...
public class GestureDetectMethod_Menu {
    ...
    public GestureDetectMethod_Menu(ArrayList<EmgData> gesture) {
        compareGesture = gesture;
        numberSmoother = new NumberSmoother();
    }
    public GestureDetectMethod_Menu(Handler handler, ArrayList<EmgData> gesture){
        compareGesture = gesture;
...
//                +streamingMaxData.getElement(7)+",");
        ...
        if(cnt%30==0){
            cnt=0;
            int result = numberSmoother.getSmoothingNumber_menu();
